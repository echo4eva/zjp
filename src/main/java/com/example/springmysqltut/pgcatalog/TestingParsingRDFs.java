package com.example.springmysqltut.pgcatalog;

import com.example.springmysqltut.Book;
...
public class TestingParsingRDFs {

    private String directory;
    public TestingParsingRDFs(String directory) {
    ...
    public ArrayList<Book> getBooks() throws IOException {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            List<String> staticSubs = subjs;
            Book testBook = new Book(id, title, release_date, language, copyright_status, publisher, staticSubs);

            extractedBooks.add(testBook);
